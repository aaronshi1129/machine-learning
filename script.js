...
function startGame() {
    ...
    // Add event listeners for Classification/Regression/Clustering buttons
    classificationBtn.addEventListener('click', () => checkAnswer('classification'));
    regressionBtn.addEventListener('click', () => checkAnswer('regression'));
    clusteringBtn.addEventListener('click', () => checkAnswer('clustering'));
...
function endGame() {
    ...
    feedback.classList.add('hidden');
    document.querySelector('.swot-buttons-container').style.display = 'none';
...
function restartGame() {
    ...
    // Reset UI
    document.querySelector('.swot-buttons-container').style.display = 'grid';
    document.querySelector('.time-bar-container').style.display = 'block';
    const restartBtn = document.querySelector('.game-container button:not(#next-btn):not(#classification-btn):not(#regression-btn):not(#clustering-btn)');
    if (restartBtn) {
        restartBtn.remove();
    }
